          ...
          <div className="MySkill" style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', gap: 56.67, display: 'inline-flex', padding: "0px 3vw" }}>
            <div className="SectionTitle" style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', gap: '3vh', display: 'flex' }}>
              ...
              <div className="Content" style={{ alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 32, display: 'flex' }}>
                ...
                <p><b>Information We Collect:</b> We collect information that you provide directly to us, such as when place an order with your shipping information, subscribe to our newsletter, or contact us. This information may include your name, email address and payment information.</p>
                <p><b>Use of Information:</b> The information we collect is used to provide and improve our services, process transactions, send you notifications, respond to your inquiries, and enhance your user experience. We may also use your information for marketing purposes, such as sending promotional emails or newsletters if you have chosen to subscribe and have opted-in.  You can choose to opt-out to receiving our newsletters at anytime.</p>
                <p><b>Sharing of Information:</b> We do not sell or trade, or otherwise transfer your personal information to outside parties, except when necessary to provide our services or comply with the law. This includes trusted third parties who assist us in operating our website, conducting our business, or servicing you, so long as those parties agree to keep this information confidential.</p>
              ...
              <div id="donationspolicy" className="MyExpertise" style={{ alignSelf: 'stretch', color: '#282938', fontSize: 'clamp(40px, 4vw, 61px)', fontFamily: 'PlayfairDisplay', fontWeight: '700', wordWrap: 'break-word' }}>
                Donations Policy
              </div>
              <p>
                Thank you for considering a donation to Exotic Relief Research & Mental Health Institute. Your support enables us to promote mental health and wellness through educational content and materials.
              </p>
              <p>
                <b>Use of Donations:</b> All donations received are managed directly by Exotic Relief Research & Mental Health Institute and are used to advance mental health care through innovative research, global exploration of natural health practices, and community outreach. Our mission includes reducing stigma, supporting neurodiversity individuals, and conducting groundbreaking research into the root causes of mental health disorders and addiction.
              </p>
              <p>
                <b>Commitment to Transparency:</b> We are dedicated to transparency regarding how donations are used. Regular updates will be provided to donors through our website and communications, ensuring you are informed about the impact of your contribution.
              </p>
              <p>
                <b>Tax Deductibility:</b> All donations made are tax-deductible, as they support our mission through our 501(c)(3) nonprofit organization.
              </p>
              <p>
                <b>Contact Information:</b> For any questions or concerns regarding donations, please use the "Contact" form on our website. We appreciate your support and are grateful for your contributions to our mission.
              </p>          
            </div>
          </div>
        </div>
