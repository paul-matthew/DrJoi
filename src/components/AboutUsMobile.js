                                ...
                                <div className="CardContent" style={{ alignSelf: 'stretch', height: '220px', padding: 32, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 32, display: 'flex',marginBottom:'50px' }}>
                                    <div className="Content" style={{ alignSelf: 'stretch', height: '30vh', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10.67, display: 'flex' }}>
                                        <div style={{ alignSelf: 'stretch', height: '30vh', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10.67, display: 'flex' }}>
                                            ...
                                            <div  style={{ alignSelf: 'stretch', color: 'black', fontSize: 'clamp(14px, 3vw, 17px)', fontFamily: 'Roboto', fontWeight: '400', wordWrap: 'break-word' }}>
                                                ...
                                                Specializing in the study of brain and behavior, I also conduct research to evaluate the efficacy and safety of medications for mental health conditions, while striving to better understand the neurobiology underlying these disorders.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="CardContent" style={{ alignSelf: 'stretch', height: '220px', padding: 32, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 32, display: 'flex',marginBottom:'50px' }}>
                                    <div className="Content" style={{ alignSelf: 'stretch', height: '30vh', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10.67, display: 'flex' }}>
                                        <div style={{ alignSelf: 'stretch', height: '30vh', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10.67, display: 'flex' }}>
                                            ...
                                            <div  style={{ alignSelf: 'stretch', color: '#1C1E53', fontSize: 'clamp(14px, 3vw, 17px)', fontFamily: 'Roboto', fontWeight: '400', wordWrap: 'break-word' }}>
                                                My educational journey reflects an unwavering dedication to advancing mental health care through a multidisciplinary lens. With a strong foundation in the medical sciences, having completed all premedical coursework and attending medical school, I developed an in-depth understanding of human biology and medicine. 
                                                ...
                                                My Master of Public Health, combined with advanced training in clinical and community-based behavioral health research, empowers me to tackle complex mental health issues with a comprehensive, research-driven, and patient-centered approach.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
