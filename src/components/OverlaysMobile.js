...
const OverlaysMobile = ({
  ...
  return (
    <div className="overlays-container-mobile" style={{ display: "none" }}>
      ...
      {/* Services */}
      <div
        className="Overlay2-mobile"
        style={{
          display: displayState,
          zIndex: displayState2,
          width: "100vw",
          height: "10vh",
          top: `${Overlay1.replace("vw", "")}%`,
          left: 0,
          position: "absolute",
      ...
      <div
        id="HoverOverlay2"
        className="HoverOverlay2-mobile"
        style={{
          zIndex: displayState2,
          ...
          left: 0,
          position: "absolute",
          backgroundColor: "rgba(120, 79, 57, 0.1)",
      ...
      <div
        id="HoverOverlay3"
        className="HoverOverlay3-mobile"
        style={{
          zIndex: displayState2,
          opacity: displayState2,
          width: "100vw",
      ...
      {desktopState === "Homedesktop3" && (
        ...
        >
          ...
          <div
            className="TextContent1 text-content3-mobile"
            style={{
              height: "50vh",
              width: "60vw",
              paddingLeft: "0vw",
