    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <form className="DealsForm" ref={formRef} style={{ width: '100%', minHeight: '30vh' }} onSubmit={handleSubmit}>
              <div className="FormGroup">
                <input type="text" id="name" name="name" placeholder={smallScreen ? "Name" : "Enter your name"} required />
              </div>
              <div className="FormGroup">
                <input type="text" id="location" name="location" placeholder={smallScreen ? "Location" : "Enter your location"} required />
              </div>
              <div className="FormGroup">
              ...
              <div className="FormGroup">
                ...
                <select id="goal" name="goal" value={goal} onChange={(e) => setGoal(e.target.value)} required>
                  <option value="" disabled>Select your goal</option>
                  <option value="discounts">Discounts for Travel</option>
                  <option value="income">Making Extra Income</option>
                  <option value="community">Joining Travel Community</option>
                  <option value="other">Other</option>
                </select>
              </div>
              {goal === 'other' && (
                <div className="FormGroup">
                  <textarea id="otherResponse" name="otherResponse" rows="4" placeholder="Please type your response" value={otherResponse} onChange={(e) => setOtherResponse(e.target.value)} required></textarea>
                </div>
              )}
              ...
              <div id="responseMessage" style={{ marginTop: '15px', color: 'black' }}>{responseMessage}</div>
            </form>
          </div>
        </div>
      </div>
