        ...
        <div className="Content" style={{ alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 32, display: 'flex' }}>
            ...
            <div className="section">
                <div className="sectionText">
                    ...
                    <p>Join me every Wednesday at 8pm for engaging live podcasts where we explore topics on dating, relationships, and personal growth. Participate in real-time discussions, ask questions, and share your experiences in a supportive community.</p>
                    <p>These sessions provide practical advice and insights to help you improve your relationships and personal development. Don't miss the chance to connect with like-minded individuals and gain valuable knowledge every Wednesday evening.</p>                
                </div>
            ...
            <div className="section">
                ...
                <div className="sectionText">
                    ...
                    <p>Offering one-on-one coaching sessions to provide you with personalized guidance and support in your dating journey. Book an appointment today to start making positive changes.</p>
                </div>
            </div>
        </FadeInSection>
      </div>
      </div>
      <a style={{float:'none', position: 'fixed', right: '-2px', top: '25%', display: 'block', zIndex: '20000'}}rel="noreferrer" target="_blank"  href="https://booking.setmore.com/scheduleappointment/d1a338ee-1d7d-447f-aaf7-9937ed4774ac"><img border="none" src="https://storage.googleapis.com/full-assets/setmore/images/1.0/Calendar/Setmore-Book-Now.png" alt="Book an appointment with Paul using Setmore"/></a>
    </div>
  );
};
